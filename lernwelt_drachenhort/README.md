...
<!-- Screenshot-Slot — sobald docs/img/lernwelt_drachenhort.png existiert, die nächste Zeile einkommentieren:
![Screenshot der Welt lernwelt_drachenhort](../docs/img/lernwelt_drachenhort.png)
-->
